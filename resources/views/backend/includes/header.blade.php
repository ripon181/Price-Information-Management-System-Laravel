			...
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand">
					...
					<div class="search-bar flex-grow-1">
						<div style="display:none;" class="position-relative search-bar-box">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ asset ('backend')}}/assets/images/avatars/admin.png" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ asset ('backend')}}/assets/images/avatars/Southbangla-logo.png" class="user-img" alt="user avatar">
							<div class="user-info ps-3">
							@php
							use Illuminate\Support\Facades\Auth;
							@endphp
							<p class="user-name mb-0">{{ Auth::guard('admin')->user()->name }}</p>
							<p style="color:#000; font-style:italic;" class="designation mb-0">{{ Auth::guard('admin')->user()->roles()->pluck('name')->implode(', ') }}</p>
							</div>
						</a>
