					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Add Product manager</li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-info">Add New Product Manager</h5>
									</div>
									<hr/>
									<form class="row g-3" action="{{ Route ('insertproductmanager')}}" method="POST" enctype="multipart/form-data">
										@csrf
										<div class="col-md-6">
										...
										<div class="col-12">
											<button type="submit" class="btn btn-info px-5">Add Product Manager</button>
										</div>
								</form>
								</div>
							</div>
