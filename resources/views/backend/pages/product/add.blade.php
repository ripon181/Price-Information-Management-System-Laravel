						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
									<form class="row g-3" action="{{ Route ('insertproduct')}}" method="POST" enctype="multipart/form-data">
										@csrf
										<div class="col-md-6">
										...
										<div class="col-6">
											...
											<select id="product_stock" class="form-select" name="product_stock">
										...
										<div class="col-md-4">
											...
											<input type="number" class="form-control" id="product_dpprice" name="product_dpprice" placeholder="0.00">
										</div>
										<div class="col-md-4">
											<label for="product_mrpprice" class="form-label">MRP Price</label>
											<input type="number" class="form-control" id="product_mrpprice" name="product_mrpprice" placeholder="0.00">
										</div>
										<div class="col-md-4">
											<label for="product_offerprice" class="form-label">Offer Price</label>
											<input type="text" class="form-control" id="product_offerprice" name="product_offerprice" placeholder="0.00">
										</div>
										<div class="col-12">
											<label for="product_shortdesc" class="form-label">Short Description</label>
											<textarea class="form-control" id="product_shortdesc" name="product_shortdesc" rows="3"></textarea>
										</div>
										<div class="col-12">
