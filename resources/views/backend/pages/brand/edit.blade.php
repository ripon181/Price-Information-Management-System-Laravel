							...
							<div class="card-body">
								<div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="name" id="inputEnterYourName" value="{{$brand->name}}" placeholder="Enter Brand Name">
										</div>
									</div>
                                    <div class="row mb-3">
										<label for="inputEnterYourName" class="col-sm-3 col-form-label">Brand Logo</label>
										<div class="col-sm-9">
											<img width="100" height="30" src="{{ asset('backend/brand/logo/' .$brand->image)}}" alt="">
										</div>
									</div>
                                    <div class="row mb-3">
										<label for="inputEnterYourName" class="col-sm-3 col-form-label">Upload a New Brand Logo</label>
										<div class="col-sm-9">
